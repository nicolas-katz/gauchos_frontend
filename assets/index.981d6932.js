...
`;function av(){const{getHomeProducts:e}=O.exports.useContext(On),[t,n]=O.exports.useState(null);return O.exports.useEffect(()=>{e(n)},[]),_("div",{children:[_(iv,{children:[_("h1",{children:["We're here to ",p("span",{children:"create"})," emotional ",p("span",{children:"experiences"})]}),p("p",{children:"We're the agency that pushes boundaries to find the most original, most thoughtful, and most compelling ways to fulfill your vision."}),_(D,{to:"/coleccion",children:["Comprar ahora ",p(ih,{})]})]}),_(ov,{children:[p("h2",{children:"Colecciones populares"}),_("div",{className:"colection__container",children:[_(D,{to:"/coleccion/verano",children:[p("img",{src:$i,alt:"Miltex Indumentaria"}),_("h4",{children:["Verano ",p(Fi,{})]})]}),_(D,{to:"/coleccion/invierno",children:[p("img",{src:$i,alt:"Miltex Indumentaria"}),_("h4",{children:["Invierno ",p(Fi,{})]})]}),_(D,{to:"/coleccion/dama",children:[p("img",{src:$i,alt:"Miltex Indumentaria"}),_("h4",{children:["Dama ",p(Fi,{})]})]}),_(D,{to:"/coleccion/seguridad",children:[p("img",{src:$i,alt:"Miltex Indumentaria"}),_("h4",{children:["Seguridad Industrial ",p(Fi,{})]})]})]})]}),_(lv,{children:[p("h2",{children:"Nuestros productos"}),p("div",{className:"products__container",children:t!==null&&t.map(r=>_(D,{to:`/coleccion/producto/${r.id}`,children:[p("img",{src:r.image,alt:r.name}),p("h6",{children:"Colecci\xF3n"}),p("h4",{children:r.name}),p("h5",{children:"$14.000,00"}),p(D,{to:`/coleccion/producto/${r.id}`,children:"Ver Detalles"})]},r.id))}),p(D,{className:"all__products",to:"/coleccion",children:"Cargar M\xE1s"})]})]})}const sv=Ie.div`
    position: fixed;
    top: 0;
    left: 0;
    z-index: 20;
...
`;function uv({state:e,state2:t,products:n}){const{showFilterBar:r,searchByName:i,searchByCategory:o,searchByColection:l,sortProducts:a}=O.exports.useContext(On),[s,u]=O.exports.useState(""),d=()=>{r(!1)},h=y=>{u(y.target.value)},g=y=>{y.preventDefault(),i(s,e),d(),t(`Resultado para busqueda: ${s}`)},x=y=>{a(n,y),d()};return _(sv,{children:[p("div",{className:"filter__header",children:p("span",{onClick:d,children:p(tv,{})})}),_("div",{className:"filter__body",children:[_("div",{children:[p("h4",{children:"Buscar por nombre"}),_("form",{onSubmit:g,children:[_("span",{children:[p(yu,{}),p("input",{onChange:h,type:"text",name:"search",id:"search",minLength:"1",placeholder:"Buscar nombre",value:s,required:!0})]}),p("button",{type:"submit",children:"Buscar"})]})]}),_("div",{children:[p("h4",{children:"Buscar por colecci\xF3n"}),p(D,{to:"/coleccion",onClick:d,children:"Todas las colecciones"}),p(D,{to:"/coleccion/verano",onClick:d,children:"Verano"}),p(D,{to:"/coleccion/invierno",onClick:d,children:"Invierno"}),p(D,{to:"/coleccion/dama",onClick:d,children:"Dama"}),p(D,{to:"/coleccion/seguridad",onClick:d,children:"Trabajo y Seguridad Industrial"})]}),_("div",{children:[p("h4",{children:"Buscar por categor\xEDa"}),p(D,{to:"/coleccion",onClick:d,children:"Todas las categor\xEDas"}),p(D,{to:"/coleccion/alpargatas",onClick:d,children:"Alpargatas"}),p(D,{to:"/coleccion/bermudas",onClick:d,children:"Bermudas"}),p(D,{to:"/coleccion/bombachas",onClick:d,children:"Bombachas"}),p(D,{to:"/coleccion/calzado",onClick:d,children:"Calzado de Trabajo"}),p(D,{to:"/coleccion/camisas",onClick:d,children:"Camisas"}),p(D,{to:"/coleccion/pantalones",onClick:d,children:"Pantalones"}),p(D,{to:"/coleccion/cargos",onClick:d,children:"Pantalones Cargo"})]}),_("div",{children:[p("h4",{children:"Ordenar por"}),p("button",{onClick:()=>x(1),children:"Nombre (A - Z)"}),p("button",{onClick:()=>x(-1),children:"Nombre (Z - A)"})]})]})]})}const cv=Ie.div`
    width: 100%;
    height: max-content;
    padding: 40px 20px;
...
`;function fv(){const{getById:e}=O.exports.useContext(On),{id:t}=Sp(),[n,r]=O.exports.useState(null);return O.exports.useEffect(()=>{e(t,r)},[t]),p(dv,{children:n!==null&&_("div",{className:"product__container",children:[p("div",{className:"product__images",children:p("img",{src:n.image})}),_("div",{className:"product__information",children:[_("span",{children:[p(D,{to:"/",children:"Inicio"}),"/",p(D,{to:"/coleccion",children:"Colecci\xF3n"}),"/",p("p",{children:n.name})]}),p("h3",{children:n.name}),p("h4",{children:"$14.000,00"}),_("h5",{children:["o ",_("label",{children:["$",14e3*(1-.2)]})," pagando en Efectivo o Tranferencia Bancaria."]}),_("div",{className:"product__buttons",children:[_("a",{href:`https://web.whatsapp.com/send?phone=5491168760961&text=Hola! Quiero m\xE1s informaci\xF3n acerca del producto ${n.name}. Gracias!`,target:"_blank",rel:"noopener noreferrer",children:["Consultar stock ",p(oh,{})]}),_("a",{href:"mailto:info@miltex.com.ar?subject=Pedido Desde La Web",target:"_blank",rel:"noopener noreferrer",children:["Comprar en MELI ",p(ih,{})]})]})]})]})})}const pv=Ie.div`
    width: 100%;
    height: max-content;
...
`;function vv(){return p(yv,{children:_("form",{children:[p("h1",{children:"Cuenta de Administrador"}),p("label",{htmlFor:"email",children:"Tu email"}),p("input",{type:"email",name:"email",id:"email",minLength:"4",maxLength:"40",placeholder:"Tu email",required:!0}),p("label",{htmlFor:"password",children:"Tu contrase\xF1a"}),p("input",{type:"password",name:"password",id:"password",minLength:"4",maxLength:"40",placeholder:"Tu contrase\xF1a",required:!0}),_("div",{children:[p("button",{type:"submit",children:"Iniciar sesi\xF3n"}),p("h5",{children:"\xBFHas olvidado tu contrase\xF1a?"})]})]})})}function xv(){return p("div",{})}const wv=Ie.div`
    width: 100%;
    height: 100vh;
    padding: 20px;
...
`;function Sv(){return _(wv,{children:[p("h1",{children:"404"}),p("h2",{children:"La p\xE1gina que estabas buscando no existe."}),p(D,{to:"/",children:"Volver al inicio"})]})}const lh="/gauchos_frontend/assets/logo.28a0ca30.png",kv=Ie.form`
    position: fixed;
    top: 0;
    left: 0;
    z-index: 20;
...
`;function zv(){return _(xp,{children:[_(Pv,{children:[_("div",{className:"footer__container__one",children:[_("div",{className:"footer__brand",children:[p(D,{to:"/",children:p("img",{src:lh,alt:"Miltex Indumentaria"})}),p("h4",{children:"Somos Miltex SA., fabricantes directos de Gaucho Indumentaria."})]}),_("div",{className:"footer__links",children:[_("div",{children:[p("h5",{children:"Navegaci\xF3n"}),p(D,{to:"/",children:"Inicio"}),p(D,{to:"/coleccion",children:"Colecci\xF3n"}),p(D,{to:"/empresa",children:"Empresa"}),p(D,{to:"/faq",children:"FAQ"}),p(D,{to:"/contacto",children:"Contacto"})]}),_("div",{children:[p("h5",{children:"Productos"}),p(D,{to:"/carrito",children:"Mi Carrito"}),p(D,{to:"/carrito",children:"C\xF3mo Comprar"}),p(D,{to:"/carrito",children:"Compra Mayorista"}),p(D,{to:"/carrito",children:"Boton de Arrepentimiento"}),p(D,{to:"/carrito",children:"Comprar en Mercado Libre"}),p(D,{to:"/carrito",children:"Descargar Catalogo"})]})]})]}),_("div",{className:"footer__suscribe",children:[p("h5",{children:"Suscribite ahora"}),p("p",{children:"Enterate de todas nuestras novedades."}),_("div",{className:"suscribe",children:[p("input",{type:"email",name:"email",id:"email",placeholder:"Ingresa Tu Email",minLength:"4",maxLength:"40",requiered:!0}),p("button",{children:"Suscribirme"})]}),_("div",{className:"media",children:[p("a",{children:p(nv,{})}),p("a",{children:p(Zy,{})}),p("a",{children:p(ev,{})})]})]})]}),p(Nv,{children:_("h6",{children:["\xA9 All rights reserved by Miltex SA. Powered by ",p("a",{children:"Nicolas Katz"}),"."]})})]})}const Rv=Ie.a`
    position: fixed;
    right: 20px;
    bottom: 20px;
    z-index: 2;
