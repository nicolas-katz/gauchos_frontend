...
`;function av({state:e,state2:t,products:n}){const{showFilterBar:r,searchByName:i,searchByCategory:o,searchByColection:l,sortProducts:a}=O.exports.useContext(hn),[s,u]=O.exports.useState(""),d=()=>{r(!1)},h=y=>{u(y.target.value)},g=y=>{y.preventDefault(),i(s,e),d(),t(`Resultado para busqueda: ${s}`)},x=y=>{a(n,y),d()};return P(lv,{children:[p("div",{className:"filter__header",children:p(Jy,{onClick:d})}),P("div",{className:"filter__body",children:[P("div",{children:[p("h4",{children:"Buscar por nombre"}),P("form",{onSubmit:g,children:[P("span",{children:[p(gu,{}),p("input",{onChange:h,type:"text",name:"search",id:"search",minLength:"1",placeholder:"Buscar nombre",value:s,required:!0})]}),p("button",{type:"submit",children:"Buscar"})]})]}),P("div",{children:[p("h4",{children:"Buscar por colecci\xF3n"}),p(H,{to:"/coleccion",onClick:d,children:"Todas las colecciones"}),p(H,{to:"/coleccion/verano",onClick:d,children:"Verano"}),p(H,{to:"/coleccion/invierno",onClick:d,children:"Invierno"}),p(H,{to:"/coleccion/dama",onClick:d,children:"Dama"}),p(H,{to:"/coleccion/seguridad",onClick:d,children:"Trabajo y Seguridad Industrial"})]}),P("div",{children:[p("h4",{children:"Buscar por categor\xEDa"}),p(H,{to:"/coleccion",onClick:d,children:"Todas las categor\xEDas"}),p(H,{to:"/coleccion/alpargatas",onClick:d,children:"Alpargatas"}),p(H,{to:"/coleccion/bermudas",onClick:d,children:"Bermudas"}),p(H,{to:"/coleccion/bombachas",onClick:d,children:"Bombachas"}),p(H,{to:"/coleccion/calzado",onClick:d,children:"Calzado de Trabajo"}),p(H,{to:"/coleccion/camisas",onClick:d,children:"Camisas"}),p(H,{to:"/coleccion/pantalones",onClick:d,children:"Pantalones"}),p(H,{to:"/coleccion/cargos",onClick:d,children:"Pantalones Cargo"})]}),P("div",{children:[p("h4",{children:"Ordenar por"}),p("button",{onClick:()=>x(1),children:"Nombre (A - Z)"}),p("button",{onClick:()=>x(-1),children:"Nombre (Z - A)"})]})]})]})}const sv=Ce.div`
    width: 100%;
    height: max-content;
...
`;function cv(){const{getById:e}=O.exports.useContext(hn),{id:t}=xp(),[n,r]=O.exports.useState(null);return O.exports.useEffect(()=>{e(t,r)},[t]),p(uv,{children:n!==null&&P("div",{className:"product__container",children:[p("div",{className:"product__images",children:p("img",{src:n.image})}),P("div",{className:"product__information",children:[P("span",{children:[p(H,{to:"/",children:"Inicio"}),"/",p(H,{to:"/coleccion",children:"Colecci\xF3n"}),"/",p("p",{children:n.name})]}),p("h3",{children:n.name}),P("div",{className:"product__buttons",children:[P("a",{href:`https://web.whatsapp.com/send?phone=5491168760961&text=Hola! Quiero m\xE1s informaci\xF3n acerca del producto ${n.name}. Gracias!`,target:"_blank",rel:"noopener noreferrer",children:["Consultar stock ",p(nh,{})]}),P(H,{to:"/contacto",children:["Realizar pedido ",p(Zy,{})]})]})]})]})})}const dv=Ce.div`
    width: 100%;
    height: max-content;
    padding: 120px 20px 60px 20px;
...
`;function hv(){return p(pv,{children:p("h1",{children:"Sobre Nosotros"})})}const mv=Ce.div`
    width: 100%;
    height: max-content;
    padding: 120px 20px 60px 20px;
...
`;function vv(){return p(yv,{children:P("form",{children:[p("h1",{children:"Cuenta de Administrador"}),p("label",{htmlFor:"email",children:"Tu email"}),p("input",{type:"email",name:"email",id:"email",minLength:"4",maxLength:"40",placeholder:"Tu email",required:!0}),p("label",{htmlFor:"password",children:"Tu contrase\xF1a"}),p("input",{type:"password",name:"password",id:"password",minLength:"4",maxLength:"40",placeholder:"Tu contrase\xF1a",required:!0}),P("div",{children:[p("button",{type:"submit",children:"Iniciar sesi\xF3n"}),p("h5",{children:"\xBFHas olvidado tu contrase\xF1a?"})]})]})})}function xv(){return p("div",{})}const wv=Ce.div`
    width: 100%;
    height: 100vh;
    padding: 20px;
...
`;function Sv(){return P(wv,{children:[p("h1",{children:"404"}),p("h2",{children:"La p\xE1gina que estabas buscando no existe."}),p(H,{to:"/",children:"Volver al inicio"})]})}const rh="/gauchos_frontend/assets/logo.28a0ca30.png",kv=Ce.form`
    position: absolute;
    top: 0;
    left: 0;
    z-index: 10;
...
`;function _v(){const{searchByName:e,showSearchBar:t}=O.exports.useContext(hn),[n,r]=O.exports.useState(""),[i,o]=O.exports.useState(null),l=d=>{r(d.target.value)},a=()=>{t(!1),r("")},s=d=>{d.preventDefault(),e(n,o)},u=()=>{a()};return P(kv,{onSubmit:s,children:[P("div",{className:"searchbar__container",children:[P("span",{children:[p(gu,{}),p("input",{onChange:l,type:"text",name:"search",id:"search",minLength:"1",placeholder:"Buscar nombre",value:n,required:!0})]}),P("div",{children:[p("button",{type:"submit",children:"Buscar"}),p(th,{onClick:a})]})]}),i!==null&&p("div",{className:"searchbar__products",children:i.map(d=>P(H,{onClick:u,to:`/coleccion/producto/${d.id}`,children:[p("img",{src:d.image,alt:d.name}),p("h4",{children:d.name})]},d.id))})]})}const Cv=Ce.header`
    position: fixed;
    top: 0;
    left: 0;
    z-index: 10;
...
`;function Ov(){return p(Rv,{href:"https://web.whatsapp.com/send?phone=5491162715898&text=Hola!%0D%0AVi%20su%20p%C3%A1gina%20web%20y%20me%20gustar%C3%ADa%20tener%20m%C3%A1s%20informaci%C3%B3n.",target:"_blank",rel:"noopener noreferrer",children:p(nh,{})})}const Tv=Ce.div`
    width: 100%;
    height: max-content;
    padding: 140px 20px 60px 20px;
