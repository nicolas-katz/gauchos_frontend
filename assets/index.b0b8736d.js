 ...
 *
 * @license MIT
 */function xp(e,t){if(e==null)return{};var n={},r=Object.keys(e),o,i;for(i=0;i<r.length;i++)o=r[i],!(t.indexOf(o)>=0)&&(n[o]=e[o]);return n}function N1(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function R1(e,t){return e.button===0&&(!t||t==="_self")&&!N1(e)}const O1=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset"],z1=["aria-current","caseSensitive","className","end","style","to","children"];function T1(e){let{basename:t,children:n,window:r}=e,o=O.exports.useRef();o.current==null&&(o.current=k0({window:r,v5Compat:!0}));let i=o.current,[l,a]=O.exports.useState({action:i.action,location:i.location});return O.exports.useLayoutEffect(()=>i.listen(a),[i]),y(_1,{basename:t,children:n,location:l.location,navigationType:l.action,navigator:i})}const A1=O.exports.forwardRef(function(t,n){let{onClick:r,relative:o,reloadDocument:i,replace:l,state:a,target:s,to:u,preventScrollReset:f}=t,p=xp(t,O1),h=g1(u,{relative:o}),x=L1(u,{replace:l,state:a,target:s,preventScrollReset:f,relative:o});function g(v){r&&r(v),v.defaultPrevented||x(v)}return y("a",{...p,href:h,onClick:i?r:g,ref:n,target:s})}),Y=O.exports.forwardRef(function(t,n){let{"aria-current":r="page",caseSensitive:o=!1,className:i="",end:l=!1,style:a,to:s,children:u}=t,f=xp(t,z1),p=Js(s,{relative:f.relative}),h=co(),x=O.exports.useContext(Xs),{navigator:g}=O.exports.useContext(so),v=g.encodeLocation?g.encodeLocation(p).pathname:p.pathname,_=h.pathname,d=x&&x.navigation&&x.navigation.location?x.navigation.location.pathname:null;o||(_=_.toLowerCase(),d=d?d.toLowerCase():null,v=v.toLowerCase());let c=_===v||!l&&_.startsWith(v)&&_.charAt(v.length)==="/",m=d!=null&&(d===v||!l&&d.startsWith(v)&&d.charAt(v.length)==="/"),S=c?r:void 0,E;typeof i=="function"?E=i({isActive:c,isPending:m}):E=[i,c?"active":null,m?"pending":null].filter(Boolean).join(" ");let z=typeof a=="function"?a({isActive:c,isPending:m}):a;return y(A1,{...f,"aria-current":S,className:E,ref:n,style:z,to:s,children:typeof u=="function"?u({isActive:c,isPending:m}):u})});var Tc;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmitImpl="useSubmitImpl",e.UseFetcher="useFetcher"})(Tc||(Tc={}));var Ac;(function(e){e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Ac||(Ac={}));function L1(e,t){let{target:n,replace:r,state:o,preventScrollReset:i,relative:l}=t===void 0?{}:t,a=y1(),s=co(),u=Js(e,{relative:l});return O.exports.useCallback(f=>{if(R1(f,n)){f.preventDefault();let p=r!==void 0?r:eo(s)===eo(u);a(e,{replace:p,state:o,preventScrollReset:i,relative:l})}},[s,a,u,r,o,n,e,i,l])}var Zs={exports:{}},ee={};/**
 * @license React
...
`;function lv({state:e,state2:t}){const{showFilterBar:n,searchByName:r}=O.exports.useContext(zn),[o,i]=O.exports.useState(""),l=()=>{n(!1)};return F(iv,{children:[y("div",{className:"filter__header",children:y(ev,{onClick:l})}),F("div",{className:"filter__body",children:[F("div",{children:[y("h4",{children:"Buscar por nombre"}),F("form",{onSubmit:u=>{u.preventDefault(),r(o,e),l(),t(`Resultado para busqueda: ${o}`)},children:[F("span",{children:[y(mu,{}),y("input",{onChange:u=>{i(u.target.value)},type:"text",name:"search",id:"search",minLength:"1",placeholder:"Buscar nombre",value:o,required:!0})]}),y("button",{type:"submit",children:"Buscar"})]})]}),F("div",{children:[y("h4",{children:"Buscar por colecci\xF3n"}),y(Y,{to:"/coleccion",onClick:l,children:"Todos las colecciones"}),y(Y,{to:"/coleccion/verano",onClick:l,children:"Verano"}),y(Y,{to:"/coleccion/invierno",onClick:l,children:"Invierno"}),y(Y,{to:"/coleccion/dama",onClick:l,children:"Dama"}),y(Y,{to:"/coleccion/seguridad",onClick:l,children:"Trabajo y Seguridad Industrial"})]}),F("div",{children:[y("h4",{children:"Buscar por categor\xEDa"}),y(Y,{to:"/coleccion",onClick:l,children:"Todos los productos"}),y(Y,{to:"/coleccion/alpargatas",onClick:l,children:"Alpargatas"}),y(Y,{to:"/coleccion/bermudas",onClick:l,children:"Bermudas"}),y(Y,{to:"/coleccion/bombachas",onClick:l,children:"Bombachas"}),y(Y,{to:"/coleccion/calzado",onClick:l,children:"Calzado de Trabajo"}),y(Y,{to:"/coleccion/camisas",onClick:l,children:"Camisas"}),y(Y,{to:"/coleccion/pantalones",onClick:l,children:"Pantalones"}),y(Y,{to:"/coleccion/cargos",onClick:l,children:"Pantalones Cargo"})]})]})]})}const av=ut.div`
    width: 100%;
    height: max-content;
...
`;function tf(){const{category:e}=vp(),{getAll:t,showFilterBar:n,showFilter:r}=O.exports.useContext(zn),[o,i]=O.exports.useState(null),[l,a]=O.exports.useState(""),s=()=>{n(!0)};return O.exports.useEffect(()=>{t(i),a(e||"Colecci\xF3n")},[e]),F(av,{children:[y("h1",{children:l}),F("div",{className:"colection__filters",children:[F("button",{className:"filter__button",onClick:s,children:["Filtrar ",y(Zy,{})]}),r&&y(lv,{state:i,state2:a})]}),y("div",{className:"colection__container",children:o!==null&&o.map(u=>F(Y,{to:`/coleccion/producto/${u.id}`,children:[y("img",{src:u.image,alt:u.name}),y("h4",{children:u.name})]},u.id))})]})}const sv=ut.div`
    width: 100%;
    height: max-content;
...
`;function uv(){const{getById:e}=O.exports.useContext(zn),{id:t}=vp(),[n,r]=O.exports.useState(null);return O.exports.useEffect(()=>{e(t,r)},[t]),y(sv,{children:n!==null&&F("div",{className:"product__container",children:[y("div",{className:"product__images",children:y("img",{src:n.image})}),F("div",{className:"product__information",children:[F("span",{children:[y(Y,{to:"/",children:"Inicio"}),"/",y(Y,{to:"/coleccion",children:"Colecci\xF3n"}),"/",y("p",{children:n.name})]}),y("h3",{children:n.name}),F("div",{className:"product__buttons",children:[F("a",{href:`https://web.whatsapp.com/send?phone=5491168760961&text=Hola! Quiero m\xE1s informaci\xF3n acerca del producto ${n.name}. Gracias!`,target:"_blank",rel:"noopener noreferrer",children:["Consultar stock ",y(th,{})]}),F(Y,{to:"/contacto",children:["Realizar pedido ",y(nv,{})]})]})]})]})})}const cv=ut.div`
    width: 100%;
    height: max-content;
    padding: 120px 20px 60px 20px;
...
`;function Sv(){const{searchByName:e,showSearchBar:t}=O.exports.useContext(zn),[n,r]=O.exports.useState(""),[o,i]=O.exports.useState(null),l=f=>{r(f.target.value)},a=()=>{t(!1),r("")},s=f=>{f.preventDefault(),e(n,i)},u=()=>{a()};return F(wv,{onSubmit:s,children:[F("div",{className:"searchbar__container",children:[F("span",{children:[y(mu,{}),y("input",{onChange:l,type:"text",name:"search",id:"search",minLength:"1",placeholder:"Buscar nombre",value:n,required:!0})]}),F("div",{children:[y("button",{type:"submit",children:"Buscar"}),y(eh,{onClick:a})]})]}),o!==null&&y("div",{className:"searchbar__products",children:o.map(f=>F(Y,{onClick:u,to:`/coleccion/producto/${f.id}`,children:[y("img",{src:f.image,alt:f.name}),y("h4",{children:f.name})]},f.id))})]})}const kv=ut.header`
    position: fixed;
    top: 0;
    left: 0;
    z-index: 10;
...
`;function Rv(){return y(Nv,{href:"https://web.whatsapp.com/send?phone=5491162715898&text=Hola!%0D%0AVi%20su%20p%C3%A1gina%20web%20y%20me%20gustar%C3%ADa%20tener%20m%C3%A1s%20informaci%C3%B3n.",target:"_blank",rel:"noopener noreferrer",children:y(th,{})})}function Ov(){return F("div",{children:[y(Cv,{}),F(P1,{children:[y(dt,{exact:!0,path:"/",element:y(Fg,{})}),y(dt,{path:"/coleccion",element:y(tf,{})}),y(dt,{path:"/coleccion/:category",element:y(tf,{})}),y(dt,{path:"/coleccion/producto/:id",element:y(uv,{})}),y(dt,{path:"/galeria",element:y(fv,{})}),y(dt,{path:"/empresa",element:y(dv,{})}),y(dt,{path:"/contacto",element:y(hv,{})}),y(dt,{path:"/acceso/login",element:y(gv,{})}),y(dt,{path:"/acceso/administrador",element:y(yv,{})}),y(dt,{path:"/*",element:y(xv,{})})]}),y(Rv,{}),y(Pv,{})]})}const zv=O.exports.createContext();function Tv(e){return y(zv.Provider,{value:{},children:e.children})}Xl.createRoot(document.getElementById("root")).render(y($t.StrictMode,{children:y(T1,{children:y(Tv,{children:y(Yy,{children:y(Ov,{})})})})}));
